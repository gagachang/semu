...
exception_t cpu_execute(struct cpu *cpu, const uint64_t insn)
{
    ...
    case 0x33: {
        ...
        if (funct3 == 0x0 && funct7 == 0x00) { /* add */
            ...
            if (divisor == 0) {
                cpu->regs[rd] = -1;
            } else if (dividend == LONG_MIN && divisor == -1) { /* overflow */
                cpu->regs[rd] = dividend;
            } else {
            ...
            } else if ((int64_t) cpu->regs[rs1] == LONG_MIN &&
    ...
    case 0x3b: {
        ...
        if (funct3 == 0x0 && funct7 == 0x00) { /* addw */
            ...
            if (cpu->regs[rs2] == 0) {
                cpu->regs[rd] = -1;
            } else if ((int32_t) cpu->regs[rs1] == INT_MIN &&
                       (int32_t) cpu->regs[rs2] == -1) { /* overflow */
                cpu->regs[rd] = (int32_t) cpu->regs[rs1];
            } else {
                cpu->regs[rd] =
